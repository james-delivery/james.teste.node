      ...
      function afterTransfer(data, compensationId) {
          return __awaiter(this, void 0, void 0, function*() {
              ...
              if (terStatus == "paid" && !hasError) {
                  ...
                  console.log("DATA para ser inserida na tabela pagarme_transfers ", data);
      ...
      function sendToPagarMe(data) {
          return __awaiter(this, void 0, void 0, function*() {
              yield node_fetch_1.default('https://api.pagar.me:443/1/transfers', {
                  method: 'post',
                  headers: {
              ...
              }).then((response) => response.json()).then((json) => __awaiter(this, void 0, void 0, function*() {
